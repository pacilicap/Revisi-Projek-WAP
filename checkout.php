...
<html>
<head>
<title>Bukapedia - Checkout</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+62)812 2222 3333</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Bukapedia</a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di Bukapedia</span></h1>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Our's Lab, Bukapedia.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">info@email</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 812 2222 3333</li>
					</ul>
				</div>
