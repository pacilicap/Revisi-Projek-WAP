...
if(!isset($_SESSION['log_admin']) && !isset($_SESSION['log'])){
    echo "<script>
        alert('Silahkan login terlebih dahulu!');
        window.location.href='login_admin.php';
        </script>";
}elseif(!isset($_SESSION['log_admin']) && isset($_SESSION['log']) && $_SESSION['role'] != 'Admin'){
       echo "<script>
...
<head>
    ...
    <title>Admin Panel - Bukapedia</title>
                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       <div class="market-status-table mt-4">
                        Anda masuk sebagai <?php echo $_SESSION['name'] ?>
                        <br>
